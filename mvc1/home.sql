...
-- Выводит категорию, название продукта и описание
SELECT 
    categories.name, product.name, product.description, product.price, product.count, product.img 
FROM 
    `categories`, 
    `product` 
WHERE 
    categories.id = product.categories_id